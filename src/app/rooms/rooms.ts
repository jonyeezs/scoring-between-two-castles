...
export const rooms: RoomDefinition[] = [
  ...
  },
  {
    ...
    type: 'sleeping',
    hanging: 'painting',
    rule: new AllTypesRule(4, 1, 6, AllSpecialRoomTypes),
  },
  {
    name: 'brandy room',
    type: 'food',
  ...
  },
  {
    ...
    type: 'living',
    hanging: 'painting',
    rule: new AdjacentRule(2, ['below', 'lower-left', 'lower-right'], 'type', [
      'downstairs',
    ]),
  },
  {
  ...
  },
  {
    ...
    type: 'living',
    hanging: 'mirror',
    rule: new AdjacentRule(2, exclude(AllDirections, ['below']), 'type', [
      'outdoor',
    ]),
  },
  {
